...
const Dubai = (props) => {
  ...
  const { nodes, materials, scene, animations } = useGLTF(
    "/images/models/dubai.glb"
  );
console.log(materials,"dubaiii");

applyProps(materials.Wayshighway__0, { metalness: 0.5, roughness: 0.4, color: '#181818' })
applyProps(materials["rastMat.001"], { metalness: 0, roughness: 0.3, color: '#000' })
...
useGLTF.preload("/images/models/dubai.glb");
